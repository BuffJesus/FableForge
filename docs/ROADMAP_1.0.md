...
1. Docs: ~~a 10-minute "first level" walkthrough with screenshots~~ DONE 2026-09-18
   ...
   DONE (`tools/gen_cli_reference.py` -> `docs/CLI.md`, regenerated by `package.py`). Still open: an
   "engine rules" FAQ page (the Setup panel + FIRST_LEVEL's table cover it for now).

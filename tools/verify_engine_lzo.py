...
Needs: the retail install, build/fableforge_lzo_tests.exe, `pip install unicorn`."""
...
subprocess.run([str(ROOT / "build" / "fableforge_lzo_tests.exe")], env=env, capture_output=True)
n = ok = 0; bad = []
